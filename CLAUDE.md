...
1. The curated recipe glossary (Firestore `recipe-glossary` collection) — 462 recipes
...
- **Seed file**: `functions/data/recipe-glossary-seed.json` (462 recipes: 129 breakfast + 160 original lunch/dinner + 173 expanded international recipes)
